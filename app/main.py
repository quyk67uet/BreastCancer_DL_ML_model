...
def add_predictions_ML(input_data):
  model = pickle.load(open("ML/model_ML.pkl", "rb"))
  scaler = pickle.load(open("ML/scaler_ML.pkl", "rb"))
...
def add_predictions_DL(input_data):
    model = keras.models.load_model("DL/model_DL.h5")
    scaler = pickle.load(open("DL/scaler_DL.pkl", "rb"))
